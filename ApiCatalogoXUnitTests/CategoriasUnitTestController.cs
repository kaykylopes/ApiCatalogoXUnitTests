...
namespace ApiCatalogoXUnitTests
{
   public class CategoriasUnitTestController
    {
        private readonly IUnitOfWork repositorio;
        ...
        public static string connectionString = "Data Source=LAPTOP-L67S55VC;Initial Catalog=CatalogoDBAPI;Integrated Security=True";
